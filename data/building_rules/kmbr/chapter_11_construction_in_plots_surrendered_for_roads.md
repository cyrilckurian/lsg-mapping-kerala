# Chapter 11: Construction in Plots Surrendered for Roads

CHAPTER XI CONSTRUCTION IN PLOTS PART OF WHICH HAS BEEN SURRENDERED FOR ROAD DEVELOPMENT 79. Provisions to apply as modified for constructions in certain plots.-
...
Provided further that the surrendered land shall not be used for purposes other than that envisaged in the scheme. 80. Use of Plot.- The Secretary may permit any use which is otherwise compatible with the uses of buildings in that area, which does not adversely affect the existing trend of development and which does not cause indirect condemnation of the uses in the neighbouring plots of land and buildings.
